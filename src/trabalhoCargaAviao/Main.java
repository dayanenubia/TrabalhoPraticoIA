...
public class Main {
    ...
    public static void main(String[] args) {
        int populacao = 20;
        double limitePeso = 400; // Capacidade máxima de peso do avião em kg
        double larguraMaxima = 300; // Largura máxima da área de carga em cm
        double alturaMaxima = 300; // Altura máxima da área de carga em cm
        double profundidadeMaxima = 400; // Profundidade máxima da área de carga em cm
